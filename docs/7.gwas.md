...
....
1982 samples (973 females, 1009 males; 1982 founders) loaded from
gwas_output/AxiomGT1v2.noRelatives.filtered.LD_prune.atopy.fam.
14471 out of 14517 variants loaded from
gwas_output/AxiomGT1v2.noRelatives.filtered.LD_prune.atopy.bim.
1 binary phenotype loaded (318 cases, 1664 controls).
...
Genomic inflation factor = 1.11456
