...
2 different software packages will be used to perform the GWAS analysis. Each one use a different statistical approach to adjust for population stratification. The genomic control λ will be used to assess the efficiency of each. 
