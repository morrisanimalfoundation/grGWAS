...
```
gcta64 --mlma-loco --bfile gcta/AxiomGT1v2.noRelatives.filtered.LD_prune.${target}.gcta --autosome-num 38 --autosome \
       --grm gcta/AxiomGT1v2.noRelatives.filtered.LD_prune.${target}.gcta_grm \
       --pheno $gwas/${target}.pheno \
