...
## 2.1. Genotyping data
The GRLS genotyping dataset is publicly available in a PLINK file format. More information about this dataset and how to access can be found [here](https://github.com/MAF-GRLS/grGWAS/blob/main/GRLS_Axiom.json).
