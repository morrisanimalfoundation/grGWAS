...
We will use 0.177 (the geometric mean of 0.25 and 0.125) as cutoff for the [KING knickship  coeffiecients](./ext_docs/KING_knickship.md) to identify 1st degree relatives.
